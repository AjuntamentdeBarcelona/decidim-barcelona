...
# Decidim::Shakapacker.register_stylesheet_import("stylesheets/decidim/barcelona/barcelona")

# If you want to do the same but include the SCSS file for the admin panel's
# main SCSS file, you can use the following method.
# Decidim::Shakapacker.register_stylesheet_import("stylesheets/decidim/barcelona/admin", group: :admin)
