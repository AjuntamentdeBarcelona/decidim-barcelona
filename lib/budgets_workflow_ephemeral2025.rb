...
# Specific Workflow for Barcelona's Ephemeral
class BudgetsWorkflowEphemeral2025 < Decidim::Budgets::Workflows::Base
  EPHEMERAL_AUTHORIZATION_HANDLER = "ephemeral_census_authorization_handler"
