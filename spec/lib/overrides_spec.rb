...
checksums = [
  {
    ...
    files: {
      ...
      "/app/models/decidim/user.rb" => "8a37ecf5391586f73aea3dc39ba67fe1", # ephemeral participation overrides
  ...
  },
  {
    ...
    files: {
      "/app/helpers/decidim/proposals/application_helper.rb" => "940488938f644b63a2ef6177f3757ca2",
