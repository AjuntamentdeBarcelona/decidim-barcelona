...
checksums = [
  {
    ...
    files: {
      ...
      "/app/models/decidim/user.rb" => "785c4eb2022aee20e4905a6c209840c3", # ephemeral participation overrides
  ...
  },
  {
    ...
    files: {
      ...
      "/app/permissions/decidim/initiatives/admin/permissions.rb" => "77c77afc172fb48cc26b22b92b2d7a9e",
