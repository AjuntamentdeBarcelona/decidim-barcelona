...
checksums = [
  {
    ...
    files: {
      ...
      "/app/models/decidim/accountability/result.rb" => "bb890c4d83a1a0a80367781445d4ff11", # external_id cleanup, not_computable_results + results position (display order)
      "/app/services/decidim/accountability/results_calculator.rb" => "e48030665ab5eb6b313d816f74773cdc",
      "/app/views/decidim/accountability/admin/results/_form.html.erb" => "1afbe7a56cada69eac1c52073df1a0fc", # external_id and weight fields + results position (display order)
  ...
  },
  {
    ...
    files: {
      ...
      "/app/controllers/concerns/decidim/admin/filterable.rb" => "c44e4fad43a41597c00bb8702fc00e8a", # filtered_collection replaced in admin/assemblies_controller_override.rb, backport https://github.com/decidim/decidim/pull/17500
  ...
  },
  {
    ...
    files: {
      "/app/controllers/decidim/assemblies/admin/assemblies_controller.rb" => "31a25fd8202298812ad920deac76ecb4", # show all children in admin list, backport https://github.com/decidim/decidim/pull/17500
