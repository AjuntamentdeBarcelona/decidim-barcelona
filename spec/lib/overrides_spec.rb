...
checksums = [
  {
    ...
    files: {
      ...
      "/config/locales/ca.yml" => "35b26c2d4b23c115652f32e1d194b691",
      "/config/locales/en.yml" => "4eb3b41f463c2a2d048bc0a8f092a5a6",
      "/config/locales/es.yml" => "7df479d1490e9fc2d168fe50c8815ad8"
    }
  },
  {
