...
# NOTE: this migration has already been splitted in 2020122700000X series
# we should keep it here to aviod having it recreated on every `bin/rake decidim:upgrade`
